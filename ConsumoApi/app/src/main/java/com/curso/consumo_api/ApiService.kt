...
// Este se combinará con la URL base: https://search.imdbot.workers.dev/search
    @GET("/search")
// Usamos @Query para añadir parámetros a la URL (ej: ?q=batman)
// La función es 'suspend' para poder ser llamada desde una corutina.
    suspend fun findMovieByTitle(@Query("q") title: String): Response<MovieSearchResponse>
}